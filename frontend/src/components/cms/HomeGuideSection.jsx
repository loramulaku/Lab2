        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <PageCard className="p-7 flex flex-col gap-6">
            <div className="flex items-center gap-2.5 pb-4 border-b border-blue-100/60">
              ...
              <p className="text-sm font-bold text-gray-900">As a candidate</p>
            </div>
            <StepList steps={CANDIDATE_STEPS} />
          ...
          <PageCard className="p-7 flex flex-col gap-6">
            <div className="flex items-center gap-2.5 pb-4 border-b border-blue-100/60">
              ...
              <p className="text-sm font-bold text-gray-900">As a recruiter</p>
            </div>
            <StepList steps={RECRUITER_STEPS} />
