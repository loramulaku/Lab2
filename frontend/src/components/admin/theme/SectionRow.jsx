...
export default function SectionRow({
  ...
  disableReorderAndVisibility = false,
}) {
  return (
    <div
      draggable={!disableReorderAndVisibility}
      onDragStart={disableReorderAndVisibility ? undefined : onDragStart}
      onDragOver={disableReorderAndVisibility ? undefined : onDragOver}
      onDrop={disableReorderAndVisibility ? undefined : onDrop}
      onDragEnd={disableReorderAndVisibility ? undefined : onDragEnd}
